...
class PacienteForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['Numero_Historia'].widget.attrs.update({'placeholder' : 'Ingrese el Numero_Historia','id':'pacienteF', 'title': "Se necesita un Numero_Historia(solo letras)", 'class':"form-control", 'type':'text', 'required':'True','onkeydown':"return validarLetras(event)"})	
		...
		self.fields['Fecha_nacimiento'].widget.attrs.update({'placeholder' : 'DD/MM/AAAA','id':'pacienteF', 'title': "Se necesita un Fecha_nacimiento", 'class':"form-control", 'type':'text','required':'True','onkeydown':"return validarLetras(event)"})
